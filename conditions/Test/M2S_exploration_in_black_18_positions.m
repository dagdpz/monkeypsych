...
%experiment='Match to sample saccades random locations';
    ...
    switch experiment
        ...
        case 'Match to sample saccades'
            ...
            All.type_con                    = 6;
            All.effector_con                = 0;
            All.timing_con                  = 5; % original timing condition !!!
            %All.timing_con                  = 6; % nystagmus timing condition !!!
            All.size_con                    = 5;
            All.color_con                   = 3; %3 !!!
...
switch Current_con.timing_con
    ...
    case 6 %'Match to sample' with nystagmus
        ...
        task.timing.cue_time_hold_var           = 0;
        task.timing.mem_time_hold               = 0;%0.3; % memory period
        task.timing.mem_time_hold_var           = 0;%0.5; % memory period variance
        task.timing.del_time_hold               = 0;
        task.timing.del_time_hold_var           = 0;
        task.timing.tar_inv_time_hold           = 0;
        task.timing.tar_inv_time_hold_var       = 0;
        task.timing.tar_time_hold               = 0.5; % selection time
        task.timing.tar_time_hold_var           = 0.0;
...
%         All_positions_right = Shuffle({right_top_far, right_bot_far, right_bot_close,right_top_close});
        ...
        All_positions_left  = Shuffle({left_top_far, left_mid_far, left_bot_far, left_top_mid, left_mid_mid, left_bot_mid, left_top_close, left_mid_close, left_bot_close});
        All_positions_right  = Shuffle({right_top_far, right_mid_far, right_bot_far, right_top_mid, right_mid_mid, right_bot_mid, right_top_close, right_mid_close, right_bot_close});
