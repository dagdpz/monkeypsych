...
%%
    ...
    for n_exp = 1:numel(esperimentazione)
        ...
        All.effector_con                    = 1; % 0 - eye, 1- hand, both
        All.stim_con                        = 0;
        All.reach_hand_con                  = 2; % 2=right 1= links, [1,2] = alterniered
        All.type_con                        = 2; %M2S = 9
        All.timing_con                      = 1;
        All.size_con                        = 1;
...
task.timing.fix_time_to_acquire_hnd = 4; % 0.5
...
task.timing.msk_time_hold=0; %MASK
...
switch Current_con.timing_con
    ...
    case 1 % choice 
        ...
        task.timing.cue_time_hold               = 0; % duration of the cue
        ...
        task.timing.tar_inv_time_to_acquire_hnd = 0.5; %0.5
        task.timing.tar_inv_time_hold           = 0;
        task.timing.tar_inv_time_hold_var       = 0;  
        task.timing.tar_time_hold               = 0.6; % target hold time
...
task.hnd.tar(2).shape.mode               = 'circle';
task.hnd.tar(3).shape.mode               = 'circle';              
