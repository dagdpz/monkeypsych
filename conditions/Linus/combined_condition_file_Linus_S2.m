...
% esperimentazione        = {'Delay_dissociated_reach'};
    ...
    for n_exp = 1:numel(esperimentazione)
        ...
        force_conditions                    = 1; % normal task 3, and 1 to repeat if he does mistake
        task.calibration                    = 0;
...
%         pool_of_angles                      = [20,0,340,160,180,200];
        ...
        switch experiment
            ...
            case 'Fixation'
                ...
                All.effector_con                    = 1;  % 1 only hand, 2 eye and hand
...
%         task.rest_sensors_ini_time              = 0.5; % s, time to hold sensor(s) in initialize_trial before trial starts
        ...
        task.timing.fix_time_hold               = 0.1; %hand fixation time 
