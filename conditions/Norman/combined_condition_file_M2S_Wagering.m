...
if ~exist('dyn','var') || dyn.trialNumber == 1
 ...
 SETTINGS.VisFeedback_rest_hand = 1;
    ...
    for n_exp = 1:numel(esperimentazione)
        ...
        All.Percentage_CueAuditiv             = 0.9; %0.9;% percentage in 10 trials how often a tone (1) should be displayed
        ...
        task.PayoffMatrix                   = [0 0.12 0.3; 0.18 0.06 -10];
        ...
        All.Nr_targets2                    = 3;%How many wagers
