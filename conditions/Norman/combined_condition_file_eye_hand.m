   ...
   % esperimentazione        = {'Delay diss_reach'};
    ...
    for n_exp = 1:numel(esperimentazione)
        ...
        All = struct('angle_cases',0,'instructed_choice_con',0,'type_con',0,'effector_con',0,'reach_hand_con',0,'excentricities',0,'stim_con',0,'timing_con',0,'size_con',0,...
            'tar_dis_con',0,'mat_dis_con',0,'cue_pos_con',0,'shape_con',0,'offset_con',0,'invert_con',0,'exact_excentricity_con_x',NaN,'exact_excentricity_con_y',NaN, 'time_neutral', 0);
        ...
        switch experiment
            ...
            case 'calibration'
                ...
                fix_eye_y                           = 0;
                fix_hnd_y                           = 0;
                pool_of_angles                      = [0]; %[20,0,340,200,180,160];
                
                All.time_neutral                    = [0.11 ]; % 0.08
                task.rest_hand                      = [0 0 ];
                task.randomize_reach_hand           = 1;
            ...
            case 'Delay diss_reach'
                ...
                All.timing_con                      = 31;
                All.size_con                        = 31;
                All.instructed_choice_con           = [0 1]; % [0] only inst, [1] only choice, [0 1] inst and choice 50%, [0 0 1] 64% inst 33% choice
            ...
            case 'RFmapping_Del_fr_gz'
                ...
                All.offset_con                      = 0;
                All.reach_hand_con                  = [1]; % randomised hands [1 2]
                All.type_con                        = 4;
                All.effector_con                    = 0;
                All.timing_con                      = 31;
                All.size_con                        = 8;
                All.instructed_choice_con           = [0];% [0] only inst, [1] only choice, [0 1] inst and choice 50%, [0 0 1] 64% inst 33% choice
...
%% REWARD TIME
task.reward.time_neutral    = repmat(Current_con.time_neutral,1,2);
...
switch Current_con.timing_con
    case 0 % 'calibration'
        task.rest_sensors_ini_time              = 0.2; % s, time to hold sensor(s) in initialize_trial before trial starts
        task.timing.wait_for_reward             = 0.1;
        task.timing.ITI_success                 = 1.5;
        task.timing.ITI_success_var             = 1;
        ...
        task.timing.fix_time_to_acquire_hnd     = 0.8;
        task.timing.tar_time_to_acquire_hnd     = 0.8;
        ...
        task.timing.cue_time_hold               = 0.100;
        task.timing.cue_time_hold_var           = 0.000;
        task.timing.mem_time_hold               = 0.800;
        task.timing.mem_time_hold_var           = 0.000;
        task.timing.del_time_hold               = 0.800;
        task.timing.del_time_hold_var           = 0.000;
    ...
    case 31 %'memory ephys'
        ...
        task.timing.tar_time_to_acquire_hnd     = 0.8;
        task.timing.tar_inv_time_to_acquire_hnd = 0.8;
        task.timing.fix_time_to_acquire_eye     = 0.8;
        task.timing.tar_time_to_acquire_eye     = 0.8;
        task.timing.tar_inv_time_to_acquire_eye = 0.8; %3
        
        task.timing.fix_time_hold               = 0.600; % 0.700
        task.timing.fix_time_hold_var           = 0.400; % 0.5
        ...
        task.timing.del_time_hold               = 0.600; % 0.800
...
%% COLORS
task.eye.fix.color_dim          = [200 0 0]; %
