...
%%
 ...
 SETTINGS.VisFeedback_rest_hand = 1;
    ...
    for n_exp = 1:numel(esperimentazione)
        ...
        force_conditions_mode               = 'completed'; %'target selected'; %'success' 'target selected'
...
%%
% task.hnd.tar(1).ringColor = 4;
% task.hnd.tar(2).ringColor = 4;
% task.hnd.tar(3).ringColor = 4;
% task.hnd.cue(1).ringColor = 4;

% task.hnd.tar(1).ringColor = 6;
% task.hnd.tar(2).ringColor = 4;
% task.hnd.tar(3).ringColor = 6;
% task.hnd.cue(1).ringColor = 6;
%% REWARD TIME
