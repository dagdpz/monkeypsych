...
%         pool_of_angles                      = [20,0,340,160,180,200];
        ...
        switch experiment
            ...
            case 'Fixation'
                ...
                All.rest_hands_con                  = 1; % 1 rest and 0 no rest
            ...
            case 'Direct_reach'
                ...
                reward_time                         =  0.16; % 6V reward system
                task.rest_hand                      = [1 1]; % not used
                ...
                All.offset_con                      = 0; %0 in the center, 1 offset
                All.reach_hand_con                  = [1 2]; %either hand
                All.type_con                        = 4;  % delay reach/saccade
                All.effector_con                    = 1;  % 3 4 6 
                All.timing_con                      = 2; % delay reach
                All.size_con                        = 1;  % Fixation/direct_reach
                All.instructed_choice_con           = [0];
                All.var_x                           = 0;
                All.var_y                           = 0;
...
switch Current_con.timing_con
   ...
   case 1 % Fixation
        ...
        task.timing.fix_time_hold               = 0.20; % 
       ...
       case 2 %'memory ephys'  'Delay'
        ...
        task.rest_sensors_ini_time              = 0.25; % s, time to hold sensor(s) in initialize_trial before trial starts
        task.timing.wait_for_reward             = 0.3;
        ...
        task.timing.tar_inv_time_to_acquire_eye = 0.3; %3
        task.timing.fix_time_hold               = 0.30; % 0.7
        task.timing.fix_time_hold_var           = 0.0; % 0.5
        task.timing.cue_time_hold               = 0.1; % 0.3
        task.timing.cue_time_hold_var           = 0; % 0
        task.timing.mem_time_hold               = 1;
        task.timing.mem_time_hold_var           = 0;
        task.timing.del_time_hold               = 0.60; % 0.7
        task.timing.del_time_hold_var           = 0.0; % 0.5
        task.timing.tar_inv_time_hold           = 0.1;% 0.5
        ...
        task.timing.fix_time_hold               = 0.60; %fixation time         
        task.timing.fix_time_hold_var           = 0.1; % 0
