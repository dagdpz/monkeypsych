...
%         pool_of_angles                      = [20,0,340,160,180,200];
        ...
        switch experiment
            ...
            case 'Fixation'
                ...
                SETTINGS.take_angles_con            = 1;
                N_repetitions                       = 100; % N trials for each condition
                ...
                All.rest_hands_con                  = 0;
                All.offset_con                      = 0;
                All.reach_hand_con                  = 1; %either hand
            ...
            case 'Direct_reach'
                ...
                reward_time                         =  0.30; % 6V reward system
                task.rest_hand                      = [0 0];
                
                All.rest_hands_con                  = 0;
                All.offset_con                      = 0;
                All.reach_hand_con                  = 2; %either hand
...
%         task.rest_sensors_ini_time              = 0.5; % s, time to hold sensor(s) in initialize_trial before trial starts
        ...
        task.timing.fix_time_hold               = 0.15; % 
...
%        task.rest_sensors_ini_time              = 0.5; % s, time to hold sensor(s) in initialize_trial before trial starts
        ...
        task.timing.ITI_fail_var                = 0;
        task.timing.fix_time_to_acquire_hnd     = 2;%1.5
        task.timing.fix_time_hold               = 0.90; %fixation time         
        task.timing.fix_time_hold_var           = 0; % 0
        task.timing.tar_time_to_acquire_hnd     = 1.5; %0.8
        task.timing.tar_time_to_acquire_eye     = 1;%0.5
        task.timing.tar_time_hold               = 0.08;
        task.timing.tar_time_hold_var           = 0.0;
        task.timing.grace_time_eye              = 0;
        task.timing.grace_time_hand             = 0;
...
task.hnd_left.color_bright      = [110 110 110];
