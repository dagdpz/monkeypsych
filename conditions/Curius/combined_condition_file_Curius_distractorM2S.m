...
%         All.rotationDifference              = All.differenceBetweenSamples*difficultyLevels;
        ...
        difficultyLevels                    = [2 1]; %easy to difficult
        All.rotations                       = 0:All.differenceBetweenSamples:90; %10 different samples %18:All.differenceBetweenSamples:54
    ...
    if  n_exp == 0 % pseudo-randomization for fMRI tasks
        ...
        if (sequence_matrix(20,ind_sequence_matrix) + sequence_matrix(23,ind_sequence_matrix))> 54
            sequence_matrix(23,ind_sequence_matrix) = -sequence_matrix(23,ind_sequence_matrix);
        end
        end
        end
    end
...
task.timing.msk_time_hold=0; %0.3; %MASK
...
switch Current_con.timing_con
    ...
    case 1 % choice 
        ...
        task.timing.tar_time_hold               = 0.1; % target hold time
...
task.eye.fix.color_bright       = [60 60 60]; % [255 0 0]
 
task.hnd_stay.color_dim_fix         = [0 0 0]; %memory period
