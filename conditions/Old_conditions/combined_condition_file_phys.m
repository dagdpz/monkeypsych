...
%      experiment='Baseline stim project direct saccades_shifted';    %lini
%     experiment='Baseline stim project memory saccades_shifted';    %lini
%      experiment='Baseline stim project direct saccades_NON_shifted';    %lini
%     experiment='Baseline stim project memory saccades_NON_shifted';    %lini    
%      experiment='Baseline stim project free gaze reaches';
%     experiment='Baseline stim project memory dissociated reaches ';

% esperimentazione = {'calibration'};
% esperimentazione = {'Baseline stim project direct saccades_shifted'};
esperimentazione = {'Baseline stim project memory saccades_shifted'};
...
for n_exp = 1:numel(esperimentazione)
    ...
    elseif strcmp(experiment,'Baseline stim project memory saccades_shifted')
    ...
    switch experiment
        ...
        case 'Baseline stim project memory saccades'
            ...
            force_conditions                = 2;
            N_repetitions                   = 10;
            task.reward.time_neutral        = [0.13 0.13]; % 0.6s -> 0.2ml per hit
            task.rest_hand                  = [0 0];
            ...
            %%
               case 'Baseline stim project direct saccades_shifted'
            SETTINGS.check_motion_jaw       = 1;
            force_conditions                = 2;
            N_repetitions                   = 5;
            task.reward.time_neutral        = [0.08 0.08];   % 0.45s -> 0.15ml per hit
            task.rest_hand                  = [0 0];
        ...
        case 'Baseline stim project memory saccades_shifted'
            SETTINGS.check_motion_jaw       = 1;
            force_conditions                = 2;
            N_repetitions                   = 1;
        ...
        case 'Baseline stim project free gaze reaches'
            SETTINGS.check_motion_jaw       = 1;
            force_conditions                = 2;
            N_repetitions                   = 10;
            task.reward.time_neutral        = [0.1 0.1];   % 0.45s -> 0.15ml per hit
        ...
        case 'Learning memory saccades'
            ...
            force_conditions                = 2;
            N_repetitions                   = 10;
            task.reward.time_neutral        = [0.07 0.07]; % 0.6s -> 0.2ml per hit
            task.rest_hand                  = [0 0];
