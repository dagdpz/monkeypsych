...
fix_offset=0;
fix_y=17;
task.hnd.fix.x      = fix_offset; 
task.hnd.fix.y      = fix_y; 
...
switch custom_trial_condition
    case  num2cell([1:N_stim_conditions])
        task.hnd.tar(1).x = 24 + fix_offset;
        task.hnd.tar(1).y = fix_y;
        task.hnd.tar(2).x = -24 + fix_offset;
        task.hnd.tar(2).y = fix_y;
    case num2cell([(N_stim_conditions+1):N_stim_conditions*2])
        task.hnd.tar(1).x = 22.5526 + fix_offset;
        task.hnd.tar(1).y = fix_y + 8.2085;
        task.hnd.tar(2).x = -22.5526 + fix_offset;
        task.hnd.tar(2).y = fix_y + 8.2085;
