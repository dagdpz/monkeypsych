...
if ~exist('dyn','var') || dyn.trialNumber == 1    
    ...
    All=struct('tar_pos_con',0,'instructed_choice_con',0,'type_con',0,'effector_con',0,'reach_hand_con',0,'stim_con',0,'timing_con',0,'size_con',0,...
...
for field_index=1:numel(all_fieldnames)
    ...
    dyn.trial_classifier(field_index) = Current_con.(all_fieldnames{field_index});
end
...
switch Current_con.timing_con
    ...
    case 3 %'memory'            
        ...
        task.timing.cue_time_hold_var       = 0;
        task.timing.mem_time_hold           = 0.5; % 0.2 microstim
        task.timing.mem_time_hold_var       = 0.3; % 0.2 microstim
...
switch Current_con.tar_pos_con % So far, 6 target positions, to be extended...
