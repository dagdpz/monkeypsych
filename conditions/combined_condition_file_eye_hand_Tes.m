...
switch Current_con.timing_con
    case 0 % 'calibration'
        ...
        task.timing.fix_time_hold               = 0.700;
        task.timing.fix_time_hold_var           = 0.500;
        task.timing.cue_time_hold               = 0.300;
...
switch Current_con.size_con
    case 0 %'calibration'
        task.eye.fix.size       = 6.5;
        task.eye.fix.radius     = 226;
        task.eye.tar(1).size    = 6.5;
        task.eye.tar(1).radius  = 226;
