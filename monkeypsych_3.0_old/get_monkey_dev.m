...
% files
task.software                       = 'C:\Projekte\fMRI-reach-decision\monkeypsych_3.0\monkeypsych_dev.m';
task.version                        = 3;
...
SETTINGS.SensorsReleasedSound       = 0;
...
task.condition_file                 = '\Projekte\fMRI-reach-decision\monkeypsych_3.0\conditions\default_conditions.txt'; % might remove at some point if only custom conditions used
...
switch monkey
    ...
    case 'Peter'
        monkey_name                 = 'LELE';
        pathname                    = 'D:\Data\Peter\20190723';
        task.vd                     = 89; %89 %32
        task.screen_uh_cm           = 12; % % defines position of screen center point over y axis (should be half of screen heigth in cm)
       
        % task.custom_conditions      = 'C:\Projekte\fMRI-Touch\monkeypsych_3.0\conditions\Peter\combined_condition_file.m';
        task.custom_conditions      = 'C:\Projekte\fMRI-reach-decision\monkeypsych_3.0\conditions\Peter\combined_condition_file.m';
    ...
    case 'Norman'
        ...
        % task.custom_conditions      = 'D:\Sources\MATLAB\monkeypsych_3.0\conditions\Norman\combined_condition_file_Norman_distractorM2S';
        % task.custom_conditions      = 'D:\Sources\MATLAB\monkeypsych_3.0\conditions\Norman\combined_condition_file_M2S_Fi2';
    ...
    case 'Cornelius'
        ...
        % task.custom_conditions      = '\Sources\MATLAB\monkeypsych_3.0\conditions\Cornelius\combined_condition_file_Cornelius_distractor_task_full';
    ...
    case 'Curius'
        ...
        SETTINGS.SoundType                  = 'XBI_sounds';
        task.custom_conditions      = 'D:\Sources\MATLAB\monkeypsych_3.0\conditions\Curius\combined_condition_file_Curius_setup_sacc.m';
        ...
        task.custom_conditions      = 'D:\Sources\MATLAB\monkeypsych_3.0\conditions\Curius\combined_condition_file_Curius_distractorM2S';
