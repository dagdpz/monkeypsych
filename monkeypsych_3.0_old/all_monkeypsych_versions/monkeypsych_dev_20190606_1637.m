...
if SETTINGS.GUI
    ...
    set(gca,'Ylim',[-SETTINGS.screen_lh_deg SETTINGS.screen_uh_deg],'Xlim',[-SETTINGS.screen_w_deg/2+500 SETTINGS.screen_w_deg/2+500],'XLimMode','manual','YLimMode','manual');
