    ...
    case 'circle_withBar'  %KK
        ...
        if isempty(par.ringColor)
           img = zeros(200,1000);  
            ...
            img(:,:,1) = par.ringColor(1)*ones(200,1000); % img = ones(20,100); 
            img(:,:,2) = par.ringColor(2)*ones(200,1000); % img = ones(20,100); 
            img(:,:,3) = par.ringColor(3)*ones(200,1000); % img = ones(20,100); 
        end
        texture = Screen('MakeTexture', SETTINGS.window, img);
