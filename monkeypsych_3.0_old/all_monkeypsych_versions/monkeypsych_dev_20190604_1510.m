...
if strcmp(SETTINGS.background_image,'rectangles')
    ...
    r = 515; %600 768
    baseRect = [0 0 r r];
    centeredRect1 = CenterRectOnPointd(baseRect, SETTINGS.screen_w_pix/6.2, SETTINGS.screen_h_pix/2);
    centeredRect2 = CenterRectOnPointd(baseRect, SETTINGS.screen_w_pix - SETTINGS.screen_w_pix/6.2, SETTINGS.screen_h_pix/2);
