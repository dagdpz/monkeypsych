        ...
        switch dyn.previousState % state in which abort occurred
            ...
            case STATE.TAR_ACQ
                if ~beh_markers(bm_eye),
                    ...
                    abort_message = 'Broke eye target fixation!'; %meaningful for memory task only
                elseif ~beh_markers(bm_hnd),
                    abort_code = ABORT_HND_TAR_ACQ_STATE;
                    abort_message = 'Broke hand target fixation!'; %meaningful for memory task only
                end
            ...
            case STATE.TAR_HOL
                if ~beh_markers(bm_eye),
                    ...
                    abort_message = 'Broke eye target fixation!';
                elseif ~beh_markers(bm_hnd),
                    abort_code = ABORT_HND_TAR_HOLD_STATE;
                    abort_message = 'Broke hand target fixation!';
                end
