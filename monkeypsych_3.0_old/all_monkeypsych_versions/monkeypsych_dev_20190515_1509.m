        ...
        switch dyn.previousState % state in which abort occurred
            case STATE.FIX_ACQ
                if ~beh_markers(bm_eye),
                    ...
                    abort_message = 'Fixation not acquired!';
...
%     SETTINGS.screen_w_pix/2-numel(dyn.abort_message)*10,SETTINGS.screen_h_pix/2
    ...
    % draw rectangles
    r = 600;
    baseRect = [0 0 r r*0.5];
    centeredRect1 = CenterRectOnPointd(baseRect, 0 + r/2, SETTINGS.screen_h_pix/2);
    centeredRect2 = CenterRectOnPointd(baseRect, SETTINGS.screen_w_pix - r/2, SETTINGS.screen_h_pix/2);
    
    rect = [centeredRect1' centeredRect2'];
    
    Screen ('FrameRect', SETTINGS.window, [0.3 0.3 0.3], rect, 1);
end
