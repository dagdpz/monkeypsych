...
global SETTINGS
SETTINGS.setup = 51;         % see switch SETTINGS.setup below
...
SETTINGS.FixationAcquisitionSound   = 1;
...
switch SETTINGS.setup,
    ...
    case 3
        ...
        SETTINGS.touchscreen_calibration.y_gain         = 113;
        SETTINGS.touchscreen_calibration.y_offset       = 342;
        SETTINGS.touchscreen_calibration.x_gain         = -190;
        SETTINGS.touchscreen_calibration.x_offset       = 1293;
        
        SETTINGS.touchscreen_calibration.x_threshold    = -2.7; %-8.2; % lowest Voltage still different from not touched
        SETTINGS.touchscreen_calibration.y_threshold    = -3; % -8.2 lowest Voltage still different from not touched
