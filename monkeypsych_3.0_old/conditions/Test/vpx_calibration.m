...
%             tar_angle                   = 20; %in degrees
            ...
            vpx_SendCommandString(['geoViewDistance '  num2str(task.vd)]);
            vpx_SendCommandString(['geoVerticalMeasure '  num2str(SETTINGS.screen_h_cm*0.7)]);
            vpx_SendCommandString(['geoHorizontalMeasure ' num2str(SETTINGS.screen_w_cm*0.7)]);            
            vpx_SendCommandString('calibration_PointLocationMethod Custom');
            
            vpx_SendCommandString('EyeA:calibration_CustomPoint 1 0.05 0.05');
            vpx_SendCommandString('EyeA:calibration_CustomPoint 2 0.05 0.25');
            vpx_SendCommandString('EyeA:calibration_CustomPoint 3 0.05 0.45');
            vpx_SendCommandString('EyeA:calibration_CustomPoint 4 0.05 0.65');
            
            vpx_SendCommandString('EyeA:calibration_CustomPoint 5 0.35 0.05');
            vpx_SendCommandString('EyeA:calibration_CustomPoint 6 0.35 0.25');
            vpx_SendCommandString('EyeA:calibration_CustomPoint 7 0.35 0.45');
            vpx_SendCommandString('EyeA:calibration_CustomPoint 8 0.35 0.65');
            
            vpx_SendCommandString('EyeA:calibration_CustomPoint 9 0.65 0.05');
            vpx_SendCommandString('EyeA:calibration_CustomPoint 10 0.65 0.25');
            vpx_SendCommandString('EyeA:calibration_CustomPoint 11 0.65 0.45');
            vpx_SendCommandString('EyeA:calibration_CustomPoint 12 0.65 0.65');            
            
            vpx_SendCommandString('EyeA:calibration_CustomPoint 13 0.95 0.05');
            vpx_SendCommandString('EyeA:calibration_CustomPoint 14 0.95 0.25');
            vpx_SendCommandString('EyeA:calibration_CustomPoint 15 0.95 0.45');
            vpx_SendCommandString('EyeA:calibration_CustomPoint 16 0.95 0.65');
