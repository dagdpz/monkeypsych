    ...
    for n_exp = 1:numel(esperimentazione)
        ...
        switch experiment
            ...
            case 'Symbolic_cue_sac_reach'
                ...
                All.timing_con                      = 32; % 31 or 33 % timing profile
                All.size_con                        = 9;
...
%% COLORS
task.eye.fix.color_dim          = [128 0 0]; % defines color of eye fixation 
task.eye.fix.color_bright       = [255 0 0];

task.hnd_right.color_dim_fix    = [0 128 0]; % defines color of hand fixation
task.hnd_right.color_bright_fix = [0 200 0]; % 255 for maximum brightness
