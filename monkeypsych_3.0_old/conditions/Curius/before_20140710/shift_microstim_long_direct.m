...
%Ordered_sequence = repmat([1 1 1 1 1 2 2 2 2],1,50);
% Ordered_sequence = repmat([1],1,200);
% Ordered_sequence = repmat([1,2,2,2],1,150);
...
%         task.microstim.fraction = 0; % from 0 to 1
        task.microstim.fraction = 0.75; % from 0 to 1
        task.microstim.state = [STATE.FIX_HOL];
        task.microstim.start{1}    = [-0.04] ;
        task.microstim.end{1}      = [-0];
%         task.microstim.start{1}    = [-0.08 -0.04] ;
%         task.microstim.end{1}      = [-0 -0];
...
%         task.microstim.start{1}    = [0 0.04 0.08 0.12 0.16] ;
%         task.microstim.end{1}      = [0.2 0.24 0.28 0.32 0.36];
         task.microstim.start{1}    = [0] ;
         task.microstim.end{1}      = [0.2];
%       task.microstim.start{1}    = [0.04 0.08 0.12] ;
%       task.microstim.end{1}      = [0.24 0.28 0.32];
%         
