...
task.timing.fix_time_to_acquire_eye = 0.5; % 1
task.timing.tar_time_to_acquire_eye = 0.5; %1
...
switch Current_con.timing_con
    ...
    case 2 % choice direct saccades
        ...
        task.timing.fix_time_hold               = 0.2;%0.5
        task.timing.fix_time_hold_var           = 0.1; %0.4
        task.timing.tar_time_hold               = 0.2; %% 0.5
