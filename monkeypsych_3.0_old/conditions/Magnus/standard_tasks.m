...
%             tar_excentricity            = 20;
%             tar_angle                   = 20; %in degrees
            pool_of_angles              =[17.5,0,342.5,162.5,180,187.5];  % angle on the screen
            ...
            All.excentricities              = [25.2];   % add larger values and check if they're on the screen
            All.angle_cases                 = [1,3,4,6];    % takes angles from pool of angles because TDT reads only integers from 1 to 255 
