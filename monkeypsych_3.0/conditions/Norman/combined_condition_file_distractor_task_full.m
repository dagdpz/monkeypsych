...
%         'choice distractor-distractor memory saccades diagonal','choice distractor-distractor memory saccades horizontal'};
    ...
    for n_exp = 1:numel(esperimentazione)
        ...
        stim_con_direct                     = [0 5 7 8 ]  ; %   [0 5 7 9] [0 1 2 3]; % stimulation: 0 - no stimulation, 5 - 250ms before "go",7 - 100ms before "go", 3 - 50ms before "go"
        stim_con_memory                     = 0;
        
        N_repetitions_single                = 1; % long: 5; short: 2x2; 1x1;
...
task.hnd.ini.x  = fix_hnd_x;
task.hnd.ini.y  = fix_hnd_y;
% fixation spot
