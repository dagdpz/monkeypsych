%% Has to be set:
% fix_eye_y (calibration: atan(eye_height_screen/viewing_distance))
% reward time
    ...
    for n_exp = 1:numel(esperimentazione)
        ...
        switch experiment
            ...
            case 'memory saccades'
                ...
                SETTINGS.take_angles_con            = 1;
                pool_of_angles                      = [0,30,150,180,210,330]; %[20,0,340,200,180,160] [0,30,150,180,210,330]
...
switch Current_con.timing_con
    ...
    case 2 %'memory saccades'
        ...
        task.timing.fix_time_hold               = 0.4; % duration of initial fixation
