...
%      experiment='RF mapping memory reaches';    
    experiment='RF mapping memory reaches 6';
    PEST_ON                         = 0;    
    task.rest_hand              = [1 1]; % only relevant for saccades
            
    switch experiment
        
                case 'RF mapping memory reaches 6'
...
%             All_type_effector_con           = 24; 
            All_type_effector_con           = 12; 
                                            % 7 Left hand memory 
                                            % 8 Right hand memory 
...
task.timing.tar_inv_time_to_acquire_eye = 1; %3
...
switch timing_con
    ...
    case {2.5, 3} %'memory'            
        ...
        task.timing.del_time_hold           = 0.2; % 0.0 microstim
        task.timing.del_time_hold_var       = 0.2; % 0.0 microstim
