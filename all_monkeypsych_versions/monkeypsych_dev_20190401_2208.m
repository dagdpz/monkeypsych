...
while true
    ...
    switch dyn.state
        ...
        case STATE.INI_TRI
            ...
            dyn.random_color_cue            = [NaN NaN NaN]; %MP for bexter task
            ...
            if task.type == 11
               ...
               dyn.random_color_cue = [task.hnd.cue.color_dim];
            end
...
%             end
        ...
        case {STATE.CUE_ON_AUDITIV}
            ...
            if task.type == 10 &&task.type == 9
            if trial(dyn.trialNumber).CueAuditiv == 1 % Play a tone
        ...
        case STATE.ITI  % ITI
            ...
            trial(dyn.trialNumber).random_color_cue = dyn.random_color_cue; %MP Bexter task
...
elseif current_state == STATE.CLOSE,
    ...
    switch task.type
        ...
        case 12 % Fixation with cue (no target selection, maintain fixation)
             task_states = [STATE.INI_TRI  STATE.CUE_ON_AUDITIV      STATE.REWARD  STATE.ITI];   
    end
