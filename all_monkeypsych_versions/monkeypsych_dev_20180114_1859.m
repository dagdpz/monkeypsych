...
%             special_error_count =  sum(strcmp( special_error, cat(2,{trial.abort_code})));
            ...
            if SETTINGS.ITI_GUI,
                ...
                if ~isempty(idx),
                    ...
                    %trial(n).state(time_state_change);
...
% par.pix.size           = stim(3);
%     
%    task.hnd.tar(3).rotation =0;
%    par.Rotation = task.hnd.tar(3).rotation;
%    task.hnd.tar(1).BarSize_L    = 4 - 0.1;
%    task.hnd.tar(1).BarSize_W    = 1;
%    par.BarSizePix1= deg2pix_withOffset (task.hnd.tar(1).BarSize_L,offset_deg);
%    par.BarSizePix2= deg2pix_withOffset (task.hnd.tar(1).BarSize_W,offset_deg);
%    par.rectBar = [par.BarSizePix2 par.BarSizePix1 par.BarSizePix2 par.BarSizePix1];
%    par.stimRect_Bar       = aux_pr2rect([stim(1)  stim(2)]', par.rectBar);
...
%     Screen('DrawTextures',SETTINGS.window, texture,[], par.stimRect_Bar, par.Rotation);
%     %    Screen(SETTINGS.window,'Flip');
    case 'circle'
