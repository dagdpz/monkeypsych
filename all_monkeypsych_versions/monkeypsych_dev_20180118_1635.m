...
switch shape
    ...
    case 'bar_masked'
        ...
        Msk_BarSizePix1= deg2pix_withOffset (par.shape.BarSize_L + 0.2 ,par.offset_deg);
        Msk_BarSizePix2= deg2pix_withOffset (par.shape.BarSize_W - 0.2,par.offset_deg);
        
        rectBar = [Msk_BarSizePix2 Msk_BarSizePix1 Msk_BarSizePix2 Msk_BarSizePix1];
        stimRect_Bar       = aux_pr2rect([par.x  par.y]', rectBar);
        rand_rect  = Shuffle(repmat([1,3],1,number_of_rects+1/2));
