...
%             end
        ...
        case STATE.REWARD % reward
            ...
            if trial(dyn.trialNumber).success && dyn.target2_selected(dyn.ta2_selected_ind) == 1
                Sounds('Reward') ;
            elseif trial(dyn.trialNumber).success && dyn.target2_selected(dyn.ta2_selected_ind) == 1
                 Sounds('Failure');
            elseif trial(dyn.trialNumber).success && dyn.target2_selected(dyn.ta2_selected_ind) == 1
                Sounds('Reward') ;
            elseif trial(dyn.trialNumber).success && dyn.target2_selected(dyn.ta2_selected_ind) == 1
