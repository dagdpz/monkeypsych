...
%% Feedback sound - test            Sounds('Reward')
            ...
            if task.check_screen_touching 
                while 1
                    ...
                    if touching,
                        ...
                        if SETTINGS.useSound && SETTINGS.TouchscreenSound && strcmp(SETTINGS.SoundType, 'Beep')
                            Beeper_PsychPortAudio(SETTINGS.audioPort,4000, 1, 0.2); Beeper_PsychPortAudio(SETTINGS.audioPort,4000, 1, 0.2);
                            WaitSecs(0.01);
                        elseif SETTINGS.useSound && SETTINGS.TouchscreenSound && strcmp(SETTINGS.SoundType, 'XBI_sounds')
                            Sounds('Reward')
                        else
                        end
                    else
            ...
            if SETTINGS.GUI
                ...
                if any(~isnan(task.hnd.fix.color_bright))
                    set(dyn.hnd_position_handle,'Color',nanmean([task.hnd.fix.color_bright],1)/255);
                        ...
                        if SETTINGS.useSound && SETTINGS.FixationAcquisitionSound && strcmp(SETTINGS.SoundType, 'Beep')
                            Beeper_PsychPortAudio(SETTINGS.audioPort,4000, 1, 0.2); Beeper_PsychPortAudio(SETTINGS.audioPort,4000, 1, 0.2);
                            WaitSecs(0.01);
                        elseif SETTINGS.useSound && SETTINGS.FixationAcquisitionSound && strcmp(SETTINGS.SoundType, 'XBI_sounds')
                            Sounds('Reward')
                        end
