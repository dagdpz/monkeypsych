...
[SETTINGS.window, SETTINGS.screenSize] = Screen(SETTINGS.whichScreen, 'Openwindow'); % 3     % put 'window' on complete screen  KK[ ],[],[],[],[],SETTINGS.AntiAlisingValue
...
%             task.hnd.fi2.pos=[task.hnd.fi2.x task.hnd.fi2.y task.hnd.fi2.size task.hnd.fi2.radius 1]; %% legacy for analysis
        ...
        case STATE.ABORT % abort
            ...
            % WaitSecs(4); % temp hack 20191212 for Bacchus training
