...
%                     task.hnd.fi2.color_bright   =task.hnd_right.color_bright_fi2;
        ...
        case STATE.REWARD % reward
            ...
            if trial(dyn.trialNumber).reward_time > 0 && trial(dyn.trialNumber).reward_time < 2, %% !!! Better SOLUTION??? KK
    ...
    % incorrect target selection goes to STATE.ABORT adn afterwards it
    % should go to STATE.REWARD in task.type = 10
...
ABORT_EYE_FI2_ACQ_STATE = 'ABORT_EYE_FI2_HOLD_STATE';
ABORT_HND_FI2_ACQ_STATE = 'ABORT_HND_FI2_HOLD_STATE';
