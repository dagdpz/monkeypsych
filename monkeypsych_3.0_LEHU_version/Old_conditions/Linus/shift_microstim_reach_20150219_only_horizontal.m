...
% Ordered_sequence = repmat([1:N_stim_conditions:N_total_conditions, 2:N_stim_conditions:N_total_conditions],1,5);  % saccade baselines
% Ordered_sequence = repmat([9:N_stim_conditions:N_total_conditions, 10:N_stim_conditions:N_total_conditions],1,5); % reach baselines
...
switch custom_trial_condition
    case  num2cell([1:N_stim_conditions*3])
...
%                 task.hnd.tar(2).y = fix_hnd_y  - tar_dis_y_high_low;
%         end
    case num2cell([(N_stim_conditions*3+1):N_stim_conditions*6])
        switch task.effector
            case 0
                task.eye.tar(1).x = fix_eye_x - tar_dis_x_at_0;
                task.eye.tar(1).y = fix_eye_y; 
