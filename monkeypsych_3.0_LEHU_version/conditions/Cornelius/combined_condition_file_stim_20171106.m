...
%     experiment='calibration';
    ...
    % experiment='Memory saccades stim';
    % experiment='Memory saccades stim at go as well';
    PEST_ON                         = 0;
    ...
    switch experiment
        ...
        case 'Direct saccades stim'
            ...
            All_tar_pos_con                 = [1,2,5:8];
            All_stim_con                    = [1:10];% [1:10] microstimulation -> cornelius timings
%             All_stim_con                    = [1];
            All_cue_pos_con                 = 1;
            All_shape_con                   = 1;
            if PEST_ON==1
        ...
        case 'Memory saccades stim at go as well'
            SETTINGS.GUI_in_acquisition     = 0;
            shuffle_conditions  =1;
            force_conditions    =2;
            
            N_repetitions               = 5;
            task.reward.time_neutral    = [0.045 0.045];
            ...
            All_tar_pos_con                 = [1,2,5:8];
            All_stim_con                    = [1];
            %            All_stim_con                    = [1,3,11,12,13,14,15];
            All_cue_pos_con                 = 1;
            All_shape_con                   = 1;
            if PEST_ON==1
                All_stim_con                = [1];
