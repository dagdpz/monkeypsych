...
if SETTINGS.GUI
    ...
    set(gca,'Ylim',[-SETTINGS.screen_h_deg/2 SETTINGS.screen_h_deg/2],'Xlim',[-SETTINGS.screen_w_deg/2 SETTINGS.screen_w_deg/2],'XLimMode','manual','YLimMode','manual'); % defines center of the GUI; Ylim changed from -SETTINGS.screen_lh_deg SETTINGS.screen_uh_deg
        ...
        switch dyn.previousState % state in which abort occurred
            ...
            case STATE.TAR_ACQ_INV
                if ~beh_markers(bm_eye),
                    ...
                    abort_message = 'No target acquired!';
                elseif ~beh_markers(bm_hnd),
...
if SETTINGS.TypedFeedback
    Screen('DrawText',  SETTINGS.window, dyn.abort_message, SETTINGS.screen_w_pix/2-numel(dyn.abort_message)*10,SETTINGS.screen_h_pix/2, [255 255 255] ,SETTINGS.BG_COLOR);
end
Screen(SETTINGS.window,'Flip');
...
%     [~, yCenter] = RectCenter(SETTINGS.screenSize);
%     
%     dyn.abort_message
%     
%     SETTINGS.screen_w_pix/2-numel(dyn.abort_message)*10,SETTINGS.screen_h_pix/2
    
    % draw rectangles
    r = 600;
    baseRect = [0 0 r*0.5 r*0.5];
    centeredRect1 = CenterRectOnPointd(baseRect, SETTINGS.screen_w_pix/4, SETTINGS.screen_h_pix/2);
    centeredRect2 = CenterRectOnPointd(baseRect, SETTINGS.screen_w_pix - SETTINGS.screen_w_pix/4, SETTINGS.screen_h_pix/2);
