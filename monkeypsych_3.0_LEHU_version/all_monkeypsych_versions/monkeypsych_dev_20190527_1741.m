...
if SETTINGS.TextFeedback
    Screen('FillRect', SETTINGS.window, SETTINGS.BG_COLOR);    
    displaybackground(SETTINGS);
    Screen('DrawText',  SETTINGS.window, dyn.abort_message, SETTINGS.screen_w_pix/2-(numel(dyn.abort_message)/4),SETTINGS.screen_h_pix/2, [255 255 255] ,SETTINGS.BG_COLOR); % text position
    Screen(SETTINGS.window,'Flip');
    tempdyn=dyn;
