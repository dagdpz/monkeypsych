...
%%KK
   ...
   par.BarSizePix= deg2pix_withOffset (task.hnd.tar(1).BarSize,offset_deg);
   par.rectBar = [0 0 20 par.BarSizePix];
   par.stimRect_Bar       = aux_pr2rect([stim(1)  stim(2)]', par.BarSizePix);
