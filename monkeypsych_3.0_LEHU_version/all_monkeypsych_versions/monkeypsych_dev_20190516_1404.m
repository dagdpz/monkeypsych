...
if SETTINGS.GUI
    ...
    set(gca,'Ylim',[-SETTINGS.screen_h_deg/2 SETTINGS.screen_h_deg/2],'Xlim',[-SETTINGS.screen_w_deg/2 SETTINGS.screen_w_deg/2],'XLimMode','manual','YLimMode','manual'); % defines center of the screen
