...
%             dyn.tar.HT = [dyn.HTeye dyn.HThnd];
        ...
        %% STATE.SUCCESS    
            ...
            % ------- TEST CHOICE WITH CORRECT TARGETS
%             if isfield(trial(dyn.trialNumber).task, 'correct_choice_target') && ...
%                     trial(dyn.trialNumber).target_selected(1) ~= trial(dyn.trialNumber).task.correct_choice_target % at the moment only for eye targets
%                 success = 0;
%                 dyn.previousState = dyn.state;
%             %else                
%                 %copy end of STATE.SUCCESS here
%             end
...
%             trial(dyn.trialNumber).timing.hnd_tar_HT = dyn.tar.HT(2);
    ...
    % TEST CHOICE WITH CORRECT TARGET
...
%             case STATE.SUCCESS % ------- TEST CHOICE WITH CORRECT TARGET
%                 abort_code = ABORT_WRONG_TARGET_SELECTED;
