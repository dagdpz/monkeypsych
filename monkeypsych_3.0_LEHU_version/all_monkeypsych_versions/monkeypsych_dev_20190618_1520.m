...
%if strcmp(monkey_name,'nor')
%[SETTINGS.window, SETTINGS.screenSize] = Screen(SETTINGS.whichScreen, 'Openwindow', [ ],[],[],[],[],0); % 3     % put 'window' on complete screen
%else
[SETTINGS.window, SETTINGS.screenSize] = Screen(SETTINGS.whichScreen, 'Openwindow');
%end
...
if SETTINGS.interface_with_scanner
    ...
    displaybackground(SETTINGS,task);
...
%             task.hnd.cue(2).y   =condition(13);
  ...
  %          trial(dyn.trialNumber).condition      = task.condition;
            ...
            for n_obj=1:dyn.n_eye_cue % n_obj=1:max(dyn.n_eye_cue,2) %
                trial(dyn.trialNumber).eye.cue(n_obj).pos   = [task.eye.cue(n_obj).x task.eye.cue(n_obj).y task.eye.cue(n_obj).size  task.eye.cue(n_obj).radius 0];
                trial(dyn.trialNumber).eye.cue(n_obj).shape = task.eye.cue(n_obj).shape;
            end
            for n_obj=1:dyn.n_hnd_cue % n_obj=1:max(dyn.n_hnd_cue,2) %
                trial(dyn.trialNumber).hnd.cue(n_obj).pos   = [task.hnd.cue(n_obj).x task.hnd.cue(n_obj).y task.hnd.cue(n_obj).size  task.hnd.cue(n_obj).radius 1];
        ...
        case STATE.FIX_ACQ  % fixation acquisition
            ...
            for n_obj=1:dyn.n_eye_fix
                ...
                par_temp.color=task.eye.fix(n_obj).color_dim;
            ...
            for n_obj=1:dyn.n_hnd_fix
                ...
                par_temp.color=task.hnd.fix(n_obj).color_dim;
        ...
        case STATE.FIX_HOL %  fixation holding_with_change_of_color
            ...
            for n_obj=1:dyn.n_eye_fix
                par_temp=trial(dyn.trialNumber).eye.fix(n_obj);
                par_temp.color=task.eye.fix(n_obj).color_bright;
                par_eye(n_obj) = aux_FillPar(par_temp);
            ...
            for n_obj=1:dyn.n_hnd_fix
                par_temp=trial(dyn.trialNumber).hnd.fix(n_obj);
                par_temp.color=task.hnd.fix(n_obj).color_bright;
                par_hnd(n_obj) = aux_FillPar(par_temp);
        ...
        case STATE.FI2_ACQ  % fixation acquisition
           % Temp = dyn.target_selected;
            ...
            for n_obj=1:dyn.n_eye_fi2
                ...
                par_temp.color=task.eye.fi2(n_obj).color_dim;
                par_eye(n_obj) = aux_FillPar(par_temp);
            ...
            for n_obj=1:dyn.n_hnd_fi2
                ...
                par_temp.color=task.hnd.fi2(n_obj).color_dim;
                par_hnd(n_obj) = aux_FillPar(par_temp);
        ...
        case STATE.FI2_HOL %  fixation holding_with_change_of_color
            ...
            for n_obj=1:dyn.n_eye_fi2
                par_temp=trial(dyn.trialNumber).eye.fi2(n_obj);
                par_temp.color=task.eye.fi2(n_obj).color_bright;
                par_eye(n_obj) = aux_FillPar(par_temp);
            ...
            for n_obj=1:dyn.n_hnd_fi2
                par_temp=trial(dyn.trialNumber).hnd.fi2(n_obj);
                par_temp.color=task.hnd.fi2(n_obj).color_bright;
                par_hnd(n_obj) = aux_FillPar(par_temp);
...
%             end
        ...
        case STATE.TAR_ACQ  % target acquisition
            ...
            if all(isnan(dyn.target_selected)) % still no target has been selected (e.g. in task.type = 2)
                ...
                par_temp.color=task.eye.tar(n_obj).color_dim;
                par_eye(n_obj) = aux_FillPar(par_temp);
...
%                         trial(dyn.trialNumber).eye.tar(n_obj).ringColor, trial(dyn.trialNumber).eye.tar(n_obj).reward_prob,trial(dyn.trialNumber).eye.tar(n_obj).ringColor2);
                ...
                par_temp.color=task.hnd.tar(n_obj).color_dim;
                par_hnd(n_obj) = aux_FillPar(par_temp);
...
%                         trial(dyn.trialNumber).hnd.tar(n_obj).ringColor, trial(dyn.trialNumber).hnd.tar(n_obj).reward_prob,trial(dyn.trialNumber).hnd.tar(n_obj).ringColor2);
                ...
                par_temp.color=task.eye.tar(dyn.target_selected(1)).color_dim;
...
%                         trial(dyn.trialNumber).eye.tar(dyn.target_selected(1)).ringColor, trial(dyn.trialNumber).eye.tar(dyn.target_selected(1)).reward_prob,trial(dyn.trialNumber).eye.tar(dyn.target_selected(1)).ringColor2);
                ...
                par_temp.color=task.hnd.tar(dyn.target_selected(2)).color_dim;
...
%                         trial(dyn.trialNumber).hnd.tar(dyn.target_selected(2)).ringColor, trial(dyn.trialNumber).hnd.tar(dyn.target_selected(2)).reward_prob,trial(dyn.trialNumber).hnd.tar(dyn.target_selected(2)).ringColor2);
            ...
            switch trial(dyn.trialNumber).effector
                case 3 % bright hnd fixation spot for dissociated memory saccades
                    ...
                    for n_obj=1:dyn.n_hnd_tar
                par_temp=trial(dyn.trialNumber).hnd.tar(n_obj);
                par_temp.color=task.hnd.fix(1).color_bright;
                par_hnd(n_obj) = aux_FillPar(par_temp);
...
%                             trial(dyn.trialNumber).hnd.tar(n_obj).ringColor, trial(dyn.trialNumber).hnd.tar(n_obj).reward_prob,trial(dyn.trialNumber).hnd.tar(n_obj).ringColor2);
                ...
                case 4 % bright eye fixation spot for dissociated memory reaches
                    ...
                    for n_obj=1:dyn.n_eye_tar
                par_temp=trial(dyn.trialNumber).eye.tar(n_obj);
                par_temp.color=task.eye.fix(1).color_bright;
                par_eye(n_obj) = aux_FillPar(par_temp);
...
%                             trial(dyn.trialNumber).eye.tar(n_obj).ringColor, trial(dyn.trialNumber).eye.tar(n_obj).reward_prob,trial(dyn.trialNumber).eye.tar(n_obj).ringColor2);
        ...
        case STATE.TAR_HOL %  target holding_with_change_of_color
            ...
            if ~isnan(dyn.target_selected(1))
                par_temp=trial(dyn.trialNumber).eye.tar(dyn.target_selected(1));
                par_temp.color=task.eye.tar(dyn.target_selected(1)).color_bright;
                par_eye = aux_FillPar(par_temp);
%                 par_eye = aux_FillPar(trial(dyn.trialNumber).eye.tar(dyn.target_selected(1)).shape, trial(dyn.trialNumber).eye.tar(dyn.target_selected(1)).pos, task.eye.fix(dyn.target_selected(1)).color_bright, ...
%                     trial(dyn.trialNumber).eye.tar(dyn.target_selected(1)).ringColor, trial(dyn.trialNumber).eye.tar(dyn.target_selected(1)).reward_prob,trial(dyn.trialNumber).eye.tar(dyn.target_selected(1)).ringColor2);
...
%                         trial(dyn.trialNumber).eye.tar(n_obj).ringColor, trial(dyn.trialNumber).eye.tar(n_obj).reward_prob,trial(dyn.trialNumber).eye.tar(n_obj).ringColor2);
            ...
            if ~isnan(dyn.target_selected(2))
                ...
                par_temp=trial(dyn.trialNumber).hnd.tar(dyn.target_selected(2));
                par_temp.color=task.hnd.tar(dyn.target_selected(2)).color_bright;
                par_hnd = aux_FillPar(par_temp);
...
%                         trial(dyn.trialNumber).hnd.tar(n_obj).ringColor, trial(dyn.trialNumber).hnd.tar(n_obj).reward_prob,trial(dyn.trialNumber).hnd.tar(n_obj).ringColor2);
        ...
        case STATE.TA2_ACQ  % target acquisition
           ...
           % if dyn.n_hnd_ta2==0;par_hnd = struct([]);end;
            ...
            if all(isnan(dyn.target_selected)) % still no target has been selected (e.g. in task.type = 2)
                ...
                par_temp.color=task.eye.ta2(n_obj).color_dim;
                par_eye(n_obj) = aux_FillPar(par_temp);
                ...
                par_temp.color=task.hnd.ta2(n_obj).color_dim;
                par_hnd(n_obj) = aux_FillPar(par_temp);
        ...
        case STATE.TA2_HOL %  target holding_with_change_of_color
            ...
            if ~isnan(dyn.target_selected(1))
                ...
                par_temp.color=task.eye.ta2(dyn.target_selected(1)).color_bright;
                par_eye = aux_FillPar(par_temp);
...
%                         trial(dyn.trialNumber).eye.ta2(n_obj).ringColor, trial(dyn.trialNumber).eye.ta2(n_obj).reward_prob,trial(dyn.trialNumber).eye.ta2(n_obj).ringColor2);
            ...
            if ~isnan(dyn.target_selected(2))
                ...
                par_temp.color=task.hnd.ta2(dyn.target_selected(2)).color_bright;
                par_hnd = aux_FillPar(par_temp);
        ...
        case {STATE.CUE_ON , STATE.DEL_PER}
            ...
            for n_obj=1:dyn.n_eye_cue
                ...
                par_temp.color=task.eye.cue(n_obj).color_dim;
...
%                     trial(dyn.trialNumber).eye.cue(n_obj).ringColor, trial(dyn.trialNumber).eye.tar(n_obj).reward_prob,trial(dyn.trialNumber).eye.cue(n_obj).ringColor2);
            ...
            for n_obj=1:dyn.n_hnd_cue
                ...
                par_temp.color=task.hnd.cue(n_obj).color_dim;
...
%aux_IsWithinRadius(x_hnd, y_hnd, par_hnd(obj).deg.x, par_hnd(obj).deg.y, par_hnd(obj).deg.radius, par_hnd(obj).deg.radius),
x0=par.deg.x;
y0=par.deg.y;
r=par.deg.radius;
is_within = 0;
...
if isfield(par_temp, 'radius_shape')
...
% par.offset_deg = atan(sqrt(tan(x_rad)^2 + tan(y_rad)^2));
% stim(3)= deg2pix_withOffset (stim(3),par.offset_deg);
% stim(4)= deg2pix_withOffset (stim(4),par.offset_deg);
% 
% [stim(1) stim(2)] = deg2pix_xy(stim(1), stim(2));
% 
% 
...
function displaybackground(SETTINGS,task)

if strcmp(SETTINGS.background_image,'rectangles')
    
    switch task.effector
        case {0,3,5}
            strct_for_targets='eye';
        case {1,2,4,6}  
            strct_for_targets='hnd';
    end
    rect=[];
    for t=1:numel(task.(strct_for_targets).tar)        
        
        

        %[dist_pixel] = deg2pix_withOffset (distance_deg,offset_deg)

    targetsize = task.(strct_for_targets).tar(t).size; %3.5; %actually just the "radius" of the square, so half the length
    visualeccx = task.(strct_for_targets).tar(t).x; %9.5; %9.5
    visualeccy = task.(strct_for_targets).tar(t).y; %9.5; %9.5
    
 x_rad = task.(strct_for_targets).tar(t).x*pi/180;
 y_rad = task.(strct_for_targets).tar(t).y*pi/180;
 offset_deg = atan(sqrt(tan(x_rad)^2 + tan(y_rad)^2));
 r= deg2pix_withOffset (targetsize,offset_deg)*2+2;
% stim(4)= deg2pix_withOffset (stim(3),par.offset_deg);
        
    
    %targetsize_px = ((SETTINGS.screen_w_pix/SETTINGS.screen_w_cm)* task.vd) *tan(targetsize*2 /2*pi/180) *2;
    %r = targetsize_px+2;
    baseRect = [0 0 r r];
    
    %visualeccx_px = (((SETTINGS.screen_w_pix/SETTINGS.screen_w_cm)* task.vd) *tan(visualeccx    /2*pi/180) *2); % +4 to fit squares perfectly
    
    %visualeccy_px = (((SETTINGS.screen_h_pix/SETTINGS.screen_h_cm)* task.vd) *tan(visualeccy    /2*pi/180) *2);% + SETTINGS.screen_lh_deg*(SETTINGS.screen_h_pix/SETTINGS.screen_h_cm)* task.vd; % +4 to fit squares perfectly
    %r = 488; %600 768

    %centeredRect1 = CenterRectOnPointd(baseRect, (SETTINGS.screen_w_pix/2) - visualecc_px, SETTINGS.screen_h_pix/2);
    %centeredRect2 = CenterRectOnPointd(baseRect, (SETTINGS.screen_w_pix/2) + visualecc_px, SETTINGS.screen_h_pix/2);
    %centeredRect = CenterRectOnPointd(baseRect, (SETTINGS.screen_w_pix/2) + visualeccx_px, visualeccy_px);
   
    
    [visualeccx_px, visualeccy_px] = deg2pix_xy (task.(strct_for_targets).tar(t).x, task.(strct_for_targets).tar(t).y);
    centeredRect = CenterRectOnPointd(baseRect, visualeccx_px, visualeccy_px);
    %centeredRect = CenterRectOnPointd(baseRect, (SETTINGS.screen_w_pix/2) + visualeccx_px, SETTINGS.screen_h_pix/2  + visualeccy_px);
    %rect = [centeredRect1' centeredRect2'];
